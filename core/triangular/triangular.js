...
exports.initialize = async function() {
    ...
    console.info(">>> Triangular Bot started at", new Date());

    scanExchanges(exchanges, markets, targetAssets);

    setInterval(async function() {
        //console.info(">>> New triangular scan at", new Date());
        scanExchanges(exchanges, markets, targetAssets);
    }, interval);
    //console.log("----------------------------- new");
};
...
/// Build a Queue
///
async function scanExchanges(exchanges, markets, targetAssets) {
    ...
    for (let targetAsset of targetAssets) {
        ...
        for (const chain of chains) {
            try {
                ...
                console.log("Error on", exchange, targetAsset);
